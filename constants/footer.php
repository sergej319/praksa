...
<body>
    ...
    <div class="footer">
        ...
        <div class="footer-navbar">
            <ul class="links">
                <li class="links-item"><a href="#" class="links-bottom">O NAMA</a></li>
                <li class="links-item"><a href="#" class="links-bottom">DVG PROIZVODI</a></li>
                <li class="links-item"><a href="#" class="links-bottom">BRENDOVI</a></li>
                <li class="links-item"><a href="#" class="links-bottom">DISTRIBUCIJA</a></li>
                <li class="links-item"><a href="#" class="links-bottom">SARADNJA</a></li>
                <li class="links-item"><a href="#" class="links-bottom">NOVOSTI</a></li>
                <li class="links-item"><a href="#" class="links-bottom">KONTAKT</a></li>
            </ul>
        </div>
        <div class="socials">
