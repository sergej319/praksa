    ...
    <div class="head">
        ...
        <div class="head-bottom">
            <div class="hb1">
                ...
                <a href="#" class="nav-link"><div class="nb-h3">DVG PROIZVODI<p class="description">naši proizvodi</p></div></a>
            ...
            <div class="hb2">
                <a href="#" class="nav-link"><div class="nb-h3-2">SARADNJA<p class="description">proširenje ponude</p></div></a>
